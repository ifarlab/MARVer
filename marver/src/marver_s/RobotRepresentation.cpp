...
//  representations.push_back(new Cylinder(0.13, 0.095));
  ...
  //silindirler olusturulurken height degerinin yarisini kullaniyoruz cunku FCL Cylinder sinifi height/2 olacak sekilde istiyor
  //yukariyi yorum satiri yapmamin sebebi bu
  //artik robot.xml dosyasini kullanacagimiz icin bu fonksiyona da ihtiyacimiz yok aslinda
  //loadGeometry() fonksiyonu tamamen yorum satiri yapilabilir
  ...
  //referance frame is BASE  //bu for dongusune ve atamalara artik gerek yok
//  for(int i = 0; i<6; i++){
//    if(i == 0 ){

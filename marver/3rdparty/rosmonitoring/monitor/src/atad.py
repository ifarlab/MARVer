...
def monitor():
	...
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('atad', anonymous=True)
	pub_error = rospy.Publisher(name = 'atad/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'atad/monitor_verdict', data_class = String, latch = True, queue_size = 1000)

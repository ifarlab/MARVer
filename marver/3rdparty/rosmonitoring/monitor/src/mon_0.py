...
def monitor():
	...
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('mon_0', anonymous=True)
	pub_error = rospy.Publisher(name = 'mon_0/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'mon_0/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/esogu-ifarlab/Desktop/hi.txt' 
	actions = {
		'chatter' : ('filter', 1)
	}
	monitor()

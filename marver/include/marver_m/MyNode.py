...
from include.marver_m.UI_MARVer_M import Ui_EditNode
from include.marver_m.MySocket import ISocket

# from nodeeditor.UI_MARVer_M.py import *

DEBUG = False


class INode(Serializable):
    """
    ...
    def onDoubleClicked(self, event):  # ##-----------------
        ...
        # window = Uİ_MainWindow()
        # self.window.show()
        self.w = QMainWindow()  # ##-----------------
        self.editWind = Ui_EditNode()  # ##-----------------
        self.editWind.setupUi(self.w)  # ##-----------------
